...
const RegisterPage = ({ onRegister }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Primeiro registrar apenas com campos obrigatórios
      const empresaDataBasica = {
        nomeEmpresa: formData.companyName,
        senha: formData.password,
        emailCorporativo: formData.corporateEmail,
        cnpj: formData.cnpj,
        nomeAdministrador: formData.adminName,
        cpfAdministrador: formData.adminCpf,
        telefone: formData.contactPhone
      };

      console.log("Enviando dados básicos para registro:", empresaDataBasica);

      const result = await register(empresaDataBasica);
